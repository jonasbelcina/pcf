...
function pcf_scripts() {
	...
	wp_register_style('pcf-bootstrap', get_template_directory_uri().'/assets/css/bootstrap' . $suffix . '.css', array(), '3.3.6' );
	...
	wp_register_script( 'pcf-bootstrap', get_template_directory_uri().'/assets/js/bootstrap' . $suffix . '.js', array(), '3.3.6', true );
	wp_register_script( 'vendor-isotope', get_template_directory_uri().'/assets/vendor/isotope.pkgd' . $suffix . '.js', array(), '1.0.0', true );
	wp_register_script( 'pcf-binarytransport', 'https://ajax.googleapis.com/ajax/libs/jquery/1.11.3/jquery.min.js', array( 'jquery'), '', true );
	wp_register_script( 'vendor-binary-transport', get_template_directory_uri().'/assets/vendor/jquery.binarytransport.js', 'https://ajax.googleapis.com/ajax/libs/jquery/1.11.3/jquery.min.js', '1.0.0', true );
	wp_register_script( 'pcf-script', get_template_directory_uri().'/assets/js/script.js', array( 'jquery'), filemtime( $themejspath ), true );

	wp_enqueue_style('pcf-bootstrap');
	wp_enqueue_style('vendor-owl-carousel');
	wp_enqueue_style('pcf-style');

	wp_enqueue_script('vendor-owl-carousel');
	wp_enqueue_script('pcf-bootstrap');
